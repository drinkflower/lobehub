export default {
  ...
  'share.privacyWarning.content':
    'Anyone with the link will be able to chat with this agent. Please note:',
  'share.privacyWarning.doNotShowAgain': 'Do not show again',
  'share.privacyWarning.items.budget':
    'Visitor conversations consume the share budget you allocate to this agent',
  'share.privacyWarning.items.files':
    'Agent files and knowledge bases stay private unless you grant read access',
  'share.privacyWarning.items.memory':
    'Your memories stay private unless you explicitly allow the agent to read them',
  'share.privacyWarning.items.tools':
    'Visitors can invoke the tools you whitelist in share settings',
  ...
  'share.settings.limits.desc': 'Caps applied to each visitor to protect your share budget.',
  ...
  'share.settings.permissions.desc': 'What visitors can access while chatting with this agent.',
  ...
  'share.settings.title': 'Share Settings',
  'share.settings.tools.desc': 'Visitors can only use the tools checked here.',
  ...
  'share.visibility.linkHint': 'Anyone with the link can chat with this agent.',
